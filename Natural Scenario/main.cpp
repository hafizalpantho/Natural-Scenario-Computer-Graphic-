...
void myKeyboard(unsigned char key, int x, int y)
{
	...
	case 'a':
	    ...
	    sndPlaySound("E:\\OTHER\\A.I.U.B\\8th semister\\Computer Graphics\\project\\CG_Scenario_Project\\music\\train.wav",SND_ASYNC|SND_LOOP);
	break;
    ...
    case 's':
        frd = false;
        bck = false;
         sndPlaySound("E:\\OTHER\\A.I.U.B\\8th semister\\Computer Graphics\\project\\CG_Scenario_Project\\music\\nature.wav",SND_ASYNC|SND_LOOP);
...
int main(int argc,char **argv)
{
    ...
    cout<<"Press c : For Sound off"<<endl<<endl;
    ...
    init();
    sndPlaySound("E:\\OTHER\\A.I.U.B\\8th semister\\Computer Graphics\\project\\CG_Scenario_Project\\music\\nature.wav",SND_ASYNC|SND_LOOP);
	//sndPlaySound("E:\\OTHER\\A.I.U.B\\8th semister\\Computer Graphics\\project\\Music.wav",SND_ASYNC|SND_LOOP);
